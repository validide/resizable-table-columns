/* FROM: https://raw.githubusercontent.com/marcuswestin/store.js/master/dist/store.modern.min.js */
  ...
  })(
    {
        ...
        (e, t, n) => {
          ...
          var d = {
            ...
            set: function (e, t) {
              return void 0 === t
                ? this.remove(e)
                : (this.storage.write(this._namespacePrefix + e, this._serialize(t)), t);
            },
            remove: function (e) {
              this.storage.remove(this._namespacePrefix + e);
            },
            each: function (e) {
              this.storage.each((n, r) => {
                e.call(this, this._deserialize(n), (r || "").replace(this._namespaceRegexp, ""));
              });
            },
            clearAll: function () {
          ...
          ((e) => {
            ...
            function o() {
              return String.prototype.trim
                ? (e) => String.prototype.trim.call(e)
            ...
            function s(e, t) {
              var n = f(e) ? [] : {};
              return c(e, (e, r) => ((n[r] = t(e, r)), !1)), n;
            }
            function c(e, t) {
              if (f(e)) {
                for (var n = 0; n < e.length; n++) if (t(e[n], n)) return e[n];
              } else for (var r in e) if (Object.hasOwn(e, r) && t(e[r], r)) return e[r];
            }
            function f(e) {
      ...
      6: [
        (e, t, n) => {
          ...
          function i(e) {
            for (var t in s) Object.hasOwn(s, t) && e(s[t], t);
          }
          function a(e) {
            delete s[e];
          }
